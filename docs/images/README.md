...
VRM rendered in Minecraft with Celerant + MCglTF ToonShader (no Iris ShaderPack).

- Model: Sendagaya Shino (VRoid Studio sample)
...
The `.vrm` itself is not vendored in this repository; download from the links above.
